...
import type { BookingDto, RoomTypeDto, RoomWithTypeDto } from "@/lib/api/apiService";
import { ssrBookingsPageData } from "@/server/ssr/dashboard-data";
...
export default async function BookingsPage() {
  ...
  try {
    const data = await ssrBookingsPageData();
