...
import { ssrRoomsPageData } from "@/server/ssr/dashboard-data";
import type { RoomTypeDto, RoomWithTypeDto } from "@/lib/api/apiService";
...
export default async function RoomsPage() {
  ...
  try {
    const data = await ssrRoomsPageData();
    rooms = data.rooms;
